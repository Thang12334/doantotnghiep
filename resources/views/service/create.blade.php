                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" placeholder="Cafe" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <label for="">Đơn vị tính</label>
                            <input name="unit" type="text" placeholder="Ly" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <label for="">Giá tiền</label>
                            <input name="price" type="number" placeholder="200.000" class="form-control" required>
                        </div>
                    </div>
